...
namespace bc
{
	...
	public partial class Popup : Form
	{
		...
		#region GUI Controls
			...
			void PopupDeactivate(object sender, EventArgs e)
			{
				this.Enabled = false;
			}
			void PopupActivated(object sender, EventArgs e)
			{
				this.Enabled = true;
			}
			#endregion
		...
		void PopupLoad(object sender, EventArgs e)
		{
			this.Opacity = 1;
		}
		
		void RadioButton1MouseMove(object sender, MouseEventArgs e)
		{
			
		}
		
		void RadioButton1MouseLeave(object sender, EventArgs e)
		{
