...
namespace bc
{
	partial class timeSelector
	{
		...
		private void InitializeComponent()
		{
			...
			this.button1.Click += new System.EventHandler(this.ImageDirSelectClick);
			// 
			// button2
			// 
			...
			this.button2.Click += new System.EventHandler(this.ImageDirSelectClick);
			// 
			// button3
			// 
			...
			this.button3.Click += new System.EventHandler(this.ImageDirSelectClick);
			// 
			// button4
			// 
			...
			this.button4.Click += new System.EventHandler(this.ImageDirSelectClick);
			// 
			// button5
			// 
			...
			this.button5.Click += new System.EventHandler(this.ImageDirSelectClick);
			// 
			// button6
			// 
			...
			this.button6.ForeColor = System.Drawing.Color.FromArgb(((int)(((byte)(170)))), ((int)(((byte)(170)))), ((int)(((byte)(170)))));
			...
			this.button6.Click += new System.EventHandler(this.ImageDirSelectClick);
			// 
			// button7
			// 
			...
			this.button7.ForeColor = System.Drawing.Color.FromArgb(((int)(((byte)(170)))), ((int)(((byte)(170)))), ((int)(((byte)(170)))));
			...
			this.Controls.Add(this.imageDirSelect);
			this.DoubleBuffered = true;
			this.FormBorderStyle = System.Windows.Forms.FormBorderStyle.None;
			this.Name = "timeSelector";
			this.ShowInTaskbar = false;
			this.StartPosition = System.Windows.Forms.FormStartPosition.Manual;
			this.Text = "timeSelector";
			this.Deactivate += new System.EventHandler(this.TimeSelectorDeactivate);
